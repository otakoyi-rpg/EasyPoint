    ...
    <div className="benefits" id = "benefits">
      <div className="container">
        <div className="benefits__header">
          <p className="benefits__header-anchor" data-aos="fade-up"  data-aos-delay="150">{frontmatter[language].anchor}</p>
      ...
      <div className="benefits__footer">
        <img src={frontmatter[language].background_bottom} className="benefits__footer-background" alt="" />
        <div className="container">
